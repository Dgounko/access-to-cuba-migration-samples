...
@Table(name = "CUSTOMER")
@Entity(name = "northwind4cuba$Customer")
public class Customer extends BaseIntIdentityIdEntity {
    private static final long serialVersionUID = 7858656052978428348L;
